...
{
<<<<<<<< HEAD:ECommerce.Infrastructure/Migrations/20240405080758_initial.cs
    public partial class initial : Migration
========
    public partial class productfilter : Migration
>>>>>>>> origin/ilkay:ECommerce.Infrastructure/Migrations/20240405083707_productfilter.cs
    {
...
========
                    { 1, new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(4996), null, "Çakmak", null, "Çok Amaçlı", 1, null },
                    { 2, new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5009), null, "Çakmak", null, "Mumlar İçin", 1, null },
                    { 3, new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5010), null, "Aksesuar", null, "Cüzdan", 1, null },
                    { 4, new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5011), null, "Aksesuar", null, "Gözlük", 1, null },
                    { 5, new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5012), null, "Aksesuar", null, "Kalem", 1, null }
>>>>>>>> origin/ilkay:ECommerce.Infrastructure/Migrations/20240405083707_productfilter.cs
                });
...
>>>>>>>> origin/damla:ECommerce.Infrastructure/Migrations/20240405080758_initial.cs
========
                    { 1, 1, "Kırmızı", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5107), null, "Bu ürünün açıklaması 1", "../../images/00285a53-201b-475e-b056-31b524c0354c.jpg", "çakmak 1", 100m, 10, 1, null },
                    { 2, 1, "Mavi", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5109), null, "Bu ürünün açıklaması 2", "../../images/00ca64ae-faaa-4235-bd98-a4bb4623bfc2.jpg", "çakmak 2", 150m, 5, 1, null },
                    { 3, 2, "Yeşil", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5111), null, "Bu ürünün açıklaması 3", "~/images/Default.png", "çakmak 3", 200m, 8, 1, null },
                    { 4, 2, "Sarı", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5112), null, "Bu ürünün açıklaması 4", "~/images/Default.png", "çakmak 4", 120m, 12, 1, null },
                    { 5, 2, "Mor", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5113), null, "Bu ürünün açıklaması 5", "~/images/9c11630d-b841-4242-9bf1-8bd8405f507a.jpg", "çakmak 5", 180m, 6, 1, null },
                    { 6, 3, "Mavi", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5115), null, "Bu ürünün açıklaması 1", "images/Aksesuar1.jpg", "Cüzdan 1", 150m, 5, 1, null },
                    { 7, 3, "Kırmızı", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5116), null, "Bu ürünün açıklaması 2", "~/images/9c11630d-b841-4242-9bf1-8bd8405f507a.jpg", "Cüzdan 2", 150m, 5, 1, null },
                    { 8, 4, "Kırmızı", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5117), null, "Bu ürünün açıklaması 2", "images/Aksesuar2.jpg", "Gözlük 1", 150m, 5, 1, null },
                    { 9, 4, "Kırmızı", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5119), null, "Bu ürünün açıklaması 2", "images/Aksesuar2.jpg", "Gözlük 2", 150m, 5, 1, null },
                    { 10, 5, "Kırmızı", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5120), null, "Bu ürünün açıklaması 2", "images/Aksesuar2.jpg", "Kalem 1", 150m, 5, 1, null },
                    { 11, 5, "Kırmızı", new DateTime(2024, 4, 5, 11, 37, 7, 580, DateTimeKind.Local).AddTicks(5121), null, "Bu ürünün açıklaması 2", "images/Aksesuar2.jpg", "Kaelm 2", 150m, 5, 1, null }
>>>>>>>> origin/ilkay:ECommerce.Infrastructure/Migrations/20240405083707_productfilter.cs
                });
