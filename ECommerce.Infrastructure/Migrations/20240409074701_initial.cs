    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 9, 10, 47, 0, 817, DateTimeKind.Local).AddTicks(7675), null, "Çakmak", null, "Çok Amaçlı", 1, null },
                    { 2, new DateTime(2024, 4, 9, 10, 47, 0, 817, DateTimeKind.Local).AddTicks(7683), null, "Çakmak", null, "Mumlar İçin", 1, null },
                    { 3, new DateTime(2024, 4, 9, 10, 47, 0, 817, DateTimeKind.Local).AddTicks(7684), null, "Aksesuar", null, "Cüzdan", 1, null },
                    { 4, new DateTime(2024, 4, 9, 10, 47, 0, 817, DateTimeKind.Local).AddTicks(7685), null, "Aksesuar", null, "Gözlük", 1, null },
                    { 5, new DateTime(2024, 4, 9, 10, 47, 0, 817, DateTimeKind.Local).AddTicks(7686), null, "Aksesuar", null, "Kalem", 1, null }
                });
