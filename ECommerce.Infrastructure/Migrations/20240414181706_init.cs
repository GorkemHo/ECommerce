    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 14, 21, 17, 5, 924, DateTimeKind.Local).AddTicks(8237), null, "Çakmak", null, "Çok Amaçlı", 1, null },
                    { 2, new DateTime(2024, 4, 14, 21, 17, 5, 924, DateTimeKind.Local).AddTicks(8247), null, "Çakmak", null, "Mumlar İçin", 1, null },
                    { 3, new DateTime(2024, 4, 14, 21, 17, 5, 924, DateTimeKind.Local).AddTicks(8248), null, "Aksesuar", null, "Cüzdan", 1, null },
                    { 4, new DateTime(2024, 4, 14, 21, 17, 5, 924, DateTimeKind.Local).AddTicks(8249), null, "Aksesuar", null, "Gözlük", 1, null },
                    { 5, new DateTime(2024, 4, 14, 21, 17, 5, 924, DateTimeKind.Local).AddTicks(8250), null, "Aksesuar", null, "Kalem", 1, null }
                });
